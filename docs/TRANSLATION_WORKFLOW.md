...
- non conservare `sourceHashes` per campi che non hanno una traduzione effettiva, salvo il caso di un override Forever che documenta un campo tradotto ereditato dalla base Classic;
